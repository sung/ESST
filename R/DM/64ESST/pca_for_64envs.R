...
##############################################################################
########## READ DATA #########################################################
dist_table <- read.table("./64ESST.txt")
...
image(x,y,as.matrix(dist_table), axes=FALSE,  main="Distance Matrix of 64 envrionments", xlab="Envrionments", ylab="Environments");
#label x-axis
